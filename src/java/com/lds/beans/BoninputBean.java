...
import com.lds.vo.DetailsbrfournitureId;
...
public class BoninputBean implements Serializable {  
    ...
    List<Detailsbcfourniture> list_Detailsbcfourniture=new ArrayList<Detailsbcfourniture>();
    list_Detailsbcfourniture=details_fourniture_bc.getDetailsbcfournitures_id(selectedBonreception.getBoncommande().getNumbc());
    Iterator li = list_Detailsbcfourniture.iterator();
        while (li.hasNext()) {
            //Recupération objet
            Detailsbcfourniture pu = (Detailsbcfourniture) li.next();
        fournitures.add(pu.getId().getNumfourniture());
        }
        return fournitures;
    }
...
public String enrDetails_four() {
   //System.out.println("ddd");
        ...
        Detailsbcfourniture dca=comm.getDetailsbcfourniture(new DetailsbcfournitureId(selectedBonreception.getBoncommande().getNumbc(),id_fourniture));
        ...
        if (dd == null) {
            Fourniture a = fourniture_dao.getFourniture(id_fourniture);
             DetailsBcFournitureHDao details_fourniture_bc=new DetailsBcFournitureHDao();
            Detailsbcfourniture d_bc=details_fourniture_bc.getDetailsbcfourniture(new DetailsbcfournitureId(selectedBonreception.getBoncommande().getNumbc(),id_fourniture));
           
            Detailsbrfourniture details = new Detailsbrfourniture(new DetailsbrfournitureId(id_fourniture,selectedBonreception.getNumreception()),a,selectedBonreception,t);
...
System.out.println("mmmmmmmmmmm");
       ...
       System.out.println("gggggggg");
        ...
        //System.out.println(selecteddetailssortiearticle.getId().getIdarticle());
        //dao.delete(selectedBonsortie.getIdsortie());
        detailsInputFournitureHDao.delete(selecteddetailsinputfourniture.getId());
        ...
        fourniture_dao.update(a);
         DetailsBcFournitureHDao details_fourniture_bc=new DetailsBcFournitureHDao();
            Detailsbcfourniture d_bc=details_fourniture_bc.getDetailsbcfourniture(new DetailsbcfournitureId(selectedBonreception.getBoncommande().getNumbc(),selecteddetailsinputfourniture.getFourniture().getNumfourniture()));
